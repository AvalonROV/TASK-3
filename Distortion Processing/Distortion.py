...
cbrow = 3 #https://stackoverflow.com/questions/31249037/calibrating-webcam-using-python-and-opencv-error?utm_medium=organic&utm_source=google_rich_qa&utm_campaign=google_rich_qa
cbcol = 3
...
#x,y,w,h = roi
#dst = dst[y:y+h, x:x+w]
cv2.imwrite('calibresult_practice222.png',dst)
